...
Elm.Main.make = function (_elm) {
   ...
   var levelQuery = $Signal.mailbox(0);
   var currentLevel = $Signal.mailbox({_: {}
                                      ,boxes: _L.fromArray([])
                                      ,dimensions: {_: {}
                                                   ,dimx: 0
                                                   ,dimy: 0}
                                      ,goals: _L.fromArray([])
                                      ,walls: _L.fromArray([])});
   var levelUrl = function (id) {
      return A2($Http.url,
      ":3000/levels/",
      _L.fromArray([{ctor: "_Tuple2"
                    ,_0: "id"
                    ,_1: $Basics.toString(id)}]));
   };
   var wallColor = A3($Color.rgb,
   255,
   255,
   255);
   ...
   80,
   100);
   var dispColor = function (color) {
      return function () {
         switch (color.ctor)
         {case "Blue":
            return A3($Color.rgb,0,0,255);
            case "Green":
            return A3($Color.rgb,0,255,0);
            case "Red":
            return A3($Color.rgb,255,0,0);}
         _U.badCase($moduleName,
         "between lines 260 and 263");
      }();
   };
   var tupFloat = function (_v1) {
      return function () {
         switch (_v1.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
         ...
         _U.badCase($moduleName,
         "on line 257, column 19 to 39");
      }();
   };
   var irect = function ($) {
      return $Basics.uncurry($Graphics$Collage.rect)(tupFloat($));
   };
   var gameDimensions = {ctor: "_Tuple2"
                        ,_0: 500
                        ,_1: 400};
   var $ = gameDimensions,
   gameWidth = $._0,
   ...
   halfWidth = $._0,
   halfHeight = $._1;
   var cellPosition = F2(function (_v5,
   _v6) {
      return function () {
         return function () {
            switch (_v5.ctor)
            {case "_Tuple2":
               return {ctor: "_Tuple2"
                      ,_0: _v6.x * _v5._0 - halfWidth + (_v5._0 / 2 | 0)
                      ,_1: _v6.y * _v5._1 - halfHeight + (_v5._1 / 2 | 0)};}
            _U.badCase($moduleName,
            "on line 277, column 6 to 95");
         }();
      }();
   });
   var displayBox = F2(function (cellDim,
   box) {
      return $Graphics$Collage.move(tupFloat(A2(cellPosition,
      cellDim,
      box)))($Graphics$Collage.filled(dispColor(box.color))(irect(cellDim)));
   });
   var displayWall = F2(function (cellDim,
   wall) {
      return $Graphics$Collage.move(tupFloat(A2(cellPosition,
      cellDim,
      wall)))($Graphics$Collage.filled(wallColor)(irect(cellDim)));
   });
   var displayGoal = F2(function (cellDim,
   goal) {
      return $Graphics$Collage.move(tupFloat(A2(cellPosition,
      cellDim,
      goal)))($Graphics$Collage.filled(dispColor(goal.color))($Basics.uncurry($Graphics$Collage.oval)(tupFloat(cellDim))));
   });
   var cellDimensions = function (_v11) {
      return function () {
         return {ctor: "_Tuple2"
                ,_0: gameWidth / _v11.dimx | 0
                ,_1: gameHeight / _v11.dimy | 0};
      }();
   };
   var comp = F2(function (f,x) {
      return $Basics.not(f(x));
   });
   var moveBox = F2(function (_v13,
   _v14) {
      return function () {
         return function () {
            return _U.replace([["x"
   ...
   var inBounds = F2(function (_v17,
   _v18) {
      return function () {
         return function () {
            return _U.cmp(_v18.x,
            0) > -1 && (_U.cmp(_v18.x,
            _v17.dimx) < 0 && (_U.cmp(_v18.y,
            0) > -1 && _U.cmp(_v18.y,
            _v17.dimy) < 0));
         }();
      }();
   });
   var occupiesSameSpot = F2(function (p1,
   p2) {
      return _U.eq(p1.x,
      p2.x) && _U.eq(p1.y,p2.y);
   });
   var clearOfPositioned = F2(function (xs,
   box) {
      return $List.isEmpty($List.filter(occupiesSameSpot(box))(xs));
   });
   var reachedGoal = F2(function (goals,
   box) {
      return $List.member(box.color)($List.map(function (_) {
         return _.color;
      })($List.filter(occupiesSameSpot(box))(goals)));
   });
   var numFrames = 8;
   var tweenVec = F3(function (_v21,
   _v22,
   frame) {
      return function () {
         switch (_v22.ctor)
         {case "_Tuple2":
            return function () {
                 return tupFloat({ctor: "_Tuple2"
                                 ,_0: _v21.dx * _v22._0 * frame / numFrames | 0
                                 ,_1: _v21.dy * _v22._1 * frame / numFrames | 0});
              }();}
         _U.badCase($moduleName,
         "on line 282, column 6 to 92");
      }();
   });
   var levelString = "{\"boxes\": [{\"x\": 3, \"y\": 5, \"color\": \"red\"}], \"goals\": [{\"x\" : 6, \"y\": 1, \"color\": \"green\"}], \"walls\": [{\"x\" : 2, \"y\": 3}], \"dimensions\": {\"width\": 10, \"height\": 20}}";
   var GameError = function (a) {
      return {ctor: "GameError"
             ,_0: a};
   };
   var PlayingLevel = function (a) {
      return {ctor: "PlayingLevel"
             ,_0: a};
   };
   var LoadLevel = function (a) {
      return {ctor: "LoadLevel"
             ,_0: a};
   };
   var defaultGame = LoadLevel(1);
   var still = {_: {},dx: 0,dy: 0};
   var tryChangeDirection = F2(function (input,
   levelState) {
      return _U.eq(levelState.direction,
      still) ? _U.replace([["direction"
                           ,input]],
      levelState) : levelState;
   });
   var stepFrame = function (levelState) {
      return _U.eq(levelState.direction,
      still) ? levelState : _U.replace([["frame"
                                        ,A2($Basics._op["%"],
                                        levelState.frame + 1,
                                        numFrames)]],
      levelState);
   };
   var LevelState = F6(function (a,
   b,
   c,
   d,
   e,
   ...
   var makeLevel = F4(function (boxes,
   goals,
   walls,
   dimensions) {
      return {_: {}
   ...
   var makeDimensions = F2(function (dimx,
   dimy) {
      return {_: {}
             ,dimx: dimx
             ,dimy: dimy};
   });
   var dimensionsDecoder = A3($Json$Decode.object2,
   makeDimensions,
   A2($Json$Decode._op[":="],
   "width",
   $Json$Decode.$int),
   ...
   var makeWall = F2(function (x,
   y) {
      return {_: {},x: x,y: y};
   });
   var wallDecoder = A3($Json$Decode.object2,
   makeWall,
   A2($Json$Decode._op[":="],
   "x",
   $Json$Decode.$int),
   ...
   "y",
   $Json$Decode.$int));
   var makeGoal = F3(function (x,
   y,
   color) {
      return {_: {}
             ,color: color
             ,goalActions: _L.fromArray([])
             ,x: x
             ,y: y};
   });
   var makeBox = F3(function (x,
   y,
   color) {
      return {_: {}
             ,boxActions: _L.fromArray([])
             ,color: color
             ,x: x
             ,y: y};
   });
   ...
   var GoalDisappear = {ctor: "GoalDisappear"};
   var determineGoalAction = F2(function (levelState,
   goal) {
      return A2(reachedGoal,
      levelState.boxes,
      goal) ? _L.fromArray([GoalDisappear]) : _L.fromArray([]);
   });
   var tagGoalAction = F2(function (levelState,
   goal) {
      return _U.replace([["goalActions"
                         ,A2(determineGoalAction,
                         levelState,
                         goal)]],
      goal);
   });
   var applyGoalActions = function (levelState) {
      return _U.replace([["goals"
                         ,A2($List.filter,
                         function ($) {
                            return comp($List.member(GoalDisappear))(function (_) {
                               return _.goalActions;
                            }($));
                         },
                         levelState.goals)]],
      levelState);
   };
   var BoxDisappear = {ctor: "BoxDisappear"};
   var BoxMove = {ctor: "BoxMove"};
   var determineBoxAction = F2(function (levelState,
   box) {
      return function () {
         var movedBox = A2(moveBox,
         levelState.direction,
         box);
         return A2(reachedGoal,
         levelState.goals,
         box) ? _L.fromArray([BoxDisappear]) : $Basics.not(A2(inBounds,
         levelState.dimensions,
         movedBox)) ? _L.fromArray([]) : $Basics.not(A2(clearOfPositioned,
         levelState.walls,
         movedBox)) ? _L.fromArray([]) : $Basics.not(A2(clearOfPositioned,
         levelState.boxes,
         movedBox)) ? _L.fromArray([]) : _L.fromArray([BoxMove]);
      }();
   });
   var tagBoxAction = F2(function (levelState,
   box) {
      return _U.replace([["boxActions"
                         ,A2(determineBoxAction,
                         levelState,
                         box)]],
      box);
   });
   var determineActions = function (levelState) {
      return _U.replace([["boxes"
                         ,A2($List.map,
                         tagBoxAction(levelState),
                         levelState.boxes)]
                        ,["goals"
                         ,A2($List.map,
                         tagGoalAction(levelState),
                         levelState.goals)]],
      levelState);
   };
   var applyBoxActions = function (levelState) {
      return function () {
         var remaining = A2($List.filter,
         function ($) {
            return comp($List.member(BoxDisappear))(function (_) {
               return _.boxActions;
            }($));
         },
         levelState.boxes);
         var mobile = A2($List.filter,
         function ($) {
            return $List.member(BoxMove)(function (_) {
               return _.boxActions;
            }($));
         },
         remaining);
         var immobile = A2($List.filter,
         comp(function ($) {
            return $List.member(BoxMove)(function (_) {
               return _.boxActions;
            }($));
         ...
         return _U.replace([["boxes"
                            ...
                            immobile,
                            A2($List.map,
                            moveBox(levelState.direction),
                            mobile))]
                           ,["direction"
                            ,$List.isEmpty(mobile) ? still : levelState.direction]],
         levelState);
      }();
   };
   var applyActions = function (levelState) {
      return applyGoalActions(applyBoxActions(levelState));
   };
   var stepLevel = F2(function (input,
   levelState) {
      return function () {
         switch (input.ctor)
         {case "TimeDelta":
            return _U.eq(levelState.frame,
              numFrames - 1) ? determineActions(applyActions(levelState)) : stepFrame(levelState);
            case "UserAction":
            return determineActions(tryChangeDirection(input._0)(levelState));}
         _U.badCase($moduleName,
         "between lines 238 and 240");
      }();
   });
   var stepGameState = F2(function (input,
   gameState) {
      return function () {
         switch (gameState.ctor)
         {case "GameError":
            return GameError(gameState._0);
            case "LoadLevel":
            return LoadLevel(gameState._0);
            case "PlayingLevel":
            return PlayingLevel(A2(stepLevel,
              input,
              gameState._0));}
         _U.badCase($moduleName,
   ...
   var tweenBox = F4(function (cellDim,
   box,
   levelState,
   element) {
      return A2($List.member,
      BoxMove,
      box.boxActions) ? A2($Graphics$Collage.move,
      A3(tweenVec,
      levelState.direction,
      cellDim,
      levelState.frame),
   ...
   levelState) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var cellDim = cellDimensions(levelState.dimensions);
                 ...
                 gameHeight,
                 A2($Basics._op["++"],
                 _L.fromArray([$Graphics$Collage.filled(backgroundColor)(irect(gameDimensions))]),
                 A2($Basics._op["++"],
                 A2($List.map,
                 function (b) {
                    return A3(tweenBox,
   ...
   gameState) {
      return function () {
         switch (gameState.ctor)
         {case "GameError":
            return $Graphics$Element.show(gameState._0);
            case "LoadLevel":
            return $Graphics$Element.show(A2($Basics._op["++"],
              "Should load level ",
              $Basics.toString(gameState._0)));
            case "PlayingLevel":
   ...
   var stringToColor = function (s) {
      ...
      "red") ? Red : _U.eq(s,
      "green") ? Green : _U.eq(s,
      "blue") ? Blue : _U.badIf($moduleName,
      "between lines 99 and 101");
   };
   var colorDecoder = A2($Json$Decode.map,
   stringToColor,
   $Json$Decode.string);
   var boxDecoder = A4($Json$Decode.object3,
   makeBox,
   A2($Json$Decode._op[":="],
   "x",
   $Json$Decode.$int),
   ...
   "color",
   colorDecoder));
   var goalDecoder = A4($Json$Decode.object3,
   makeGoal,
   A2($Json$Decode._op[":="],
   "x",
   $Json$Decode.$int),
   ...
   "color",
   colorDecoder));
   var levelDecoder = A5($Json$Decode.object4,
   makeLevel,
   A2($Json$Decode._op[":="],
   "boxes",
   $Json$Decode.list(boxDecoder)),
   A2($Json$Decode._op[":="],
   "goals",
   $Json$Decode.list(goalDecoder)),
   A2($Json$Decode._op[":="],
   "walls",
   $Json$Decode.list(wallDecoder)),
   A2($Json$Decode._op[":="],
   "dimensions",
   dimensionsDecoder));
   var level = A2($Json$Decode.decodeString,
   levelDecoder,
   levelString);
   ...
   var queryLevel = Elm.Native.Task.make(_elm).performSignal("queryLevel",
   $Signal.map(function (task) {
      return A2($Task.andThen,
      task,
      $Signal.send(currentLevel.address));
   })($Signal.map(getLevel)(levelQuery.signal)));
   var LevelLoaded = function (a) {
      return {ctor: "LevelLoaded"
             ,_0: a};
   };
   ...
   var input = $Signal.mergeMany(_L.fromArray([A2($Signal._op["<~"],
                                              ...
                                              LevelLoaded,
                                              currentLevel.signal)]));
   var levelState = A3($Signal.foldp,
   stepGameState,
   defaultGame,
   input);
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,Blue: Blue
                      ,BoxMove: BoxMove
                      ,BoxDisappear: BoxDisappear
                      ,GoalDisappear: GoalDisappear
                      ...
                      ,wallDecoder: wallDecoder
                      ,dimensionsDecoder: dimensionsDecoder
                      ,levelDecoder: levelDecoder
                      ,level: level
                      ,defaultGame: defaultGame
                      ,numFrames: numFrames
                      ,occupiesSameSpot: occupiesSameSpot
                      ,inBounds: inBounds
                      ,clearOfPositioned: clearOfPositioned
                      ,reachedGoal: reachedGoal
                      ,determineBoxAction: determineBoxAction
                      ,tagBoxAction: tagBoxAction
                      ,determineGoalAction: determineGoalAction
                      ,tagGoalAction: tagGoalAction
                      ,moveBox: moveBox
                      ,comp: comp
                      ,determineActions: determineActions
                      ,applyBoxActions: applyBoxActions
                      ,applyGoalActions: applyGoalActions
                      ,applyActions: applyActions
                      ,tryChangeDirection: tryChangeDirection
                      ,stepFrame: stepFrame
                      ,stepLevel: stepLevel
                      ,stepGameState: stepGameState
